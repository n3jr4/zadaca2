    ...
    public static void main(String[] args) {
        ...
        if ((spentMoney > 0)) {
            if (givenMoney > 100) {
                ...
                double leftOfChange = change;
                System.out.println(leftOfChange);

                if ((leftOfChange / apoen20) >= 1) {
                    double numberOf20 = (leftOfChange / apoen20);
                    ...
                    leftOfChange = leftOfChange - (numApoen20 * apoen20);
                }

                if ((leftOfChange / apoen10) >= 1) {
                    double numberOf10 = (leftOfChange / apoen10);
                    ...
                    leftOfChange = leftOfChange - (numApoen10 * 10);
                }

                if ((leftOfChange / apoen2) >= 1) {
                    double numberOf2 = (leftOfChange / apoen2);
                    ...
                    leftOfChange = leftOfChange - (numApoen2 * apoen2);
                }

                if ((leftOfChange / apoen1) >= 1) {
                    double numberOf1 = (leftOfChange / apoen1);
                    ...
                    leftOfChange = leftOfChange - (numApoen1 * apoen1);
                }

                if ((leftOfChange / apoen05) >= 1) {
                    double numberOf05 = (leftOfChange / apoen05);
                    ...
                    leftOfChange = leftOfChange - (numApoen05 * apoen05);
                }

                if ((leftOfChange / apoen02) >= 1) {
                    double numberOf02 = (leftOfChange / apoen02);
                    ...
                    leftOfChange = leftOfChange - (numApoen02 * apoen02);
                }

                if ((leftOfChange / apoen01) >= 1) {
                    double numberOf01 = (leftOfChange / apoen01);
                    ...
                    leftOfChange = leftOfChange - (numApoen01 * apoen01);
                }

                if ((leftOfChange / apoen001) >= 1) {
                    double numberOf001 = (leftOfChange / apoen001);
                ...
                if ((change == leftOfChange) || (leftOfChange > 0)) {
